	...
	if( typeof FB != 'undefined' ) {
		FB.getLoginStatus(function(response) {
			if( response.status == 'connected' ) {
				...
				$('a[href="/users/auth/facebook"]').attr('href','https://m.facebook.com/dialog/permissions.request?app_id=348686001852732&next=http%3A%2F%2Ftheballot.org%2Fusers%2Fauth%2Ffacebook%2Fcallback&response_type=code&perms=email%2Coffline_access%2Cfriends_activities%2Cuser_location%2Cfriends_location%2Cuser_activities%2Cuser_status%2Cuser_photos%2Cpublish_stream&fbconnect=1')
			} else {
			}
